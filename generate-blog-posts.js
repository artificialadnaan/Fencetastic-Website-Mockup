...

{
  ...
  content: `
    ...
    <p>For 6-foot privacy fencing in Frisco, posts should be set at a minimum of 30 inches deep, with 36 inches preferred for end posts and gate posts. This isn't our opinion — it's structural engineering. The International Building Code calls for one-third of the total post length below grade. A 6-foot fence on a 4x4 post should have the post cut at 9 feet total, with 3 feet underground.</p>

    <p>We use 4x4 posts set in 50-pound bags of fast-setting concrete for standard runs, and 6x6 posts for corners and gates. Every post gets a concrete collar that extends 2 inches above grade to prevent moisture wicking. In neighborhoods like <a href="/frisco">Phillips Creek Ranch</a> and Starwood, where lots are larger and wind exposure is greater, we automatically upgrade to 36-inch depth across the board.</p>
    ...
    <h2>Metal Posts: The Upgrade Worth Considering</h2>
    <p>Steel posts wrapped in wood sleeves give you the look of a traditional <a href="/wood-fences">cedar fence</a> with the wind resistance of a <a href="/metal-fences">metal fence</a>. We install galvanized steel posts on properties with high wind exposure — typically corner lots, lots backing to open fields, and properties along the Tollway corridor where wind channels between developments.</p>

    <p>The cost premium is roughly 20-25% over standard wood posts, but the structural benefit is enormous. Steel posts don't rot, don't shift in clay soil the way wood does, and can handle wind loads that would snap a standard 4x4. For Frisco homeowners who've already replaced a wind-damaged fence once, this upgrade pays for itself the first time a spring storm rolls through.</p>
...

{
  ...
  content: `
    ...
    <p>Our Plano installation protocol addresses clay soil specifically. We dig oversized holes — 12 inches in diameter instead of 10 — and go to 30-36 inches deep. The extra diameter provides a larger concrete footing that resists the lateral pressure of expanding clay. The extra depth reaches below the "active zone" where the most dramatic moisture changes occur. In most of Plano, the top 18-24 inches of soil experience the most expansion and contraction; below that, moisture content is more stable.</p>

    <p>We also bell the bottom of the hole — widening the base of the hole to create a mushroom-shaped footing. This bell acts as an anchor against the upward heaving forces that clay soil exerts during wet periods. It's more labor-intensive than a straight-sided hole, but it's the difference between a post that stays plumb for 20 years and one that starts leaning in two.</p>
...

{
  ...
  content: `
    ...
    <p>For Colleyville properties, we recommend upgrading from standard 4x4 cedar posts to 6x6 posts with decorative post caps. The visual difference is dramatic — the thicker posts read as substantial and deliberate rather than utilitarian. We also install steel reinforcement posts at gate locations and corners, wrapped in cedar sleeves so they match the fence aesthetically while providing the structural support that heavy automated gates demand.</p>
...
<p>Regardless of soil type, every fence post in North Texas should be set in concrete, not gravel. The expansion-contraction cycling of North Texas soils, the wind loads during storm season, and the moisture cycling between wet springs and dry summers all conspire against gravel-set posts. Concrete provides a rigid anchor that resists all three forces. It costs slightly more and takes slightly longer, but it's the foundation of a fence that lasts 20 years instead of 10.</p>
